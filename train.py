...
parser.add_argument("--checkpoint_dir", type=str, default="checkpoints", help='path to folder for saving checkpoints')
parser.add_argument("--checkpoint", type=str,default="checkpoints/SuperSloMo2.ckpt", help='path of checkpoint for pretrained model')
