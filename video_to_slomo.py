...
parser.add_argument("--video", type=str, default = 'umbrella.mp4', help='path of video to be converted')
parser.add_argument("--checkpoint", type=str, default = 'checkpoints/SuperSloMo.ckpt', help='path of checkpoint for pretrained model')
parser.add_argument("--fps", type=float, default=30, help='specify fps of output video. Default: 30.')
parser.add_argument("--sf", type=int, default = 16, help='specify the slomo factor N. This will increase the frames by Nx. Example sf=2 ==> 2x frames')
...
parser.add_argument("--output", type=str, default="umbrella_out.mp4", help='Specify output file name. Default: output.mp4')
